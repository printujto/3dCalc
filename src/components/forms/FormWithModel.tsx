    ...
    return (
        <div>
            ...
            <section className='mt-2 text-right'>
                ...
                {orderPrice < 200 && (
                    <div>
                        ...
                        <div className='flex justify-end gap-2'>
                            <label className='text-sm' htmlFor='agreePrice'>
                                Souhlasím, s tiskem za minimální cenovou úroveň
                                (200 Kč)
                            </label>
                            <input
                ...
                <Button className='mt-2 bg-gradient-to-tr from-violet from-30% to-pink text-white shadow-lg flex-1 text-lg font-semibold py-1'>
